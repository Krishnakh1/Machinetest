...
public class B_End 
{
	...
	driver.findElement(By.xpath("//*[@id=\"kt_login\"]/div/div[2]/kt-login/div[1]/a")).click()	;	
			Thread.sleep(5000);
			driver.findElement(By.xpath("//*[@id=\"mat-input-2\"]")).sendKeys("krishna kharde");
			Thread.sleep(5000);
			driver.findElement(By.cssSelector("input[placeholder=\"Mobile No\"]")).sendKeys("9373518243");
			driver.findElement(By.cssSelector("input[autocomplete=\"off\"]")).sendKeys("krishnakharde222@gmail.com");
			...
			driver.findElement(By.xpath("//*[@id=\"mat-input-7\"]")).sendKeys("Krish@123");
			driver.findElement(By.xpath("//*[@id=\"mat-input-8\"]")).sendKeys("Krish@123");
	...
	public void Add_customers() throws InterruptedException 
	{
		...
		Thread.sleep(5000);
		driver.findElement(By.cssSelector("input[formcontrolname=\"LeadName\"]")).sendKeys("Amar bande");
		Thread.sleep(5000);
		driver.findElement(By.id("mat-input-52")).sendKeys("00123");
		Thread.sleep(5000);
		driver.findElement(By.id("mat-input-53")).sendKeys("krish kharde");
		Thread.sleep(5000);
